@extends('layouts.app')
@section('title', __('Modify model'))
@section('content') 
<main class="wrapper">
    <div class="container-form">
        <h1>@lang('Modify model')</h1>
        <form method="POST" class="form">
            ...
            <div class="form-inputContainer">
                <div class="control-input">
                    ...
                    <input type="text" name="nom" class="input" id="nom" value="{{ old('nom', $modele->nom) }}">
                </div>
                ...
                <div class="control-input">
                    ...
                    <select name="marque_id" id="marque_id" class="input input-placeholder" data-js-select>
                        ...
                        @foreach($marques as $marque)
                            <option data-js-marque="{{ $marque->id }}" value="{{ $marque->id }}" {{ old('marque_id', $marque->id) == $marque->id ? 'selected' : '' }}>{{ $marque->nom }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="control-erreur">
