@extends('layouts.app')
@section('title', __('Modify fuel type'))
@section('content') 
<main class="wrapper">
    <div class="container-form">
        <h1>@lang('Modify fuel type')</h1>
        <form method="POST" class="form">
            ...
            <div class="form-inputContainer">
                <div class="control-input">
                    ...
                    <input type="text" name="en" class="input" id="en" value="{{ old('en', $carburant->nom['en']) }}">
                </div>
            ...
            <div class="form-inputContainer">
                <div class="control-input">
                    ...
                    <input type="text" name="fr" class="input" id="fr" value="{{ old('fr', $carburant->nom['fr']) }}">
                </div>
                <div class="control-erreur">
                    @if($errors->has('fr'))
                        {{ $errors->first('fr')}}
